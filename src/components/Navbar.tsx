...
export function Navbar({
  ...
  const links = [
    { name: t.besoins, href: `/?lang=${lang}#besoins` },
    { name: t.solutions, href: `/?lang=${lang}#solutions` },
    { name: lang === "fr" ? "Qui sommes-nous" : "Who we are", href: `/?lang=${lang}#about` },
    { name: t.contact, href: `/?lang=${lang}#contact` },
  ];
