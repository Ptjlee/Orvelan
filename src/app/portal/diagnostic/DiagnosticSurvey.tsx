...
export default function DiagnosticSurvey({ lang = 'fr' }: { lang?: 'fr'|'en' }) {
  ...
  return (
    <div className="flex-grow flex items-center justify-center py-12 px-6 md:px-12 w-full max-w-7xl mx-auto">
      <div className="max-w-4xl w-full">
        {!submitted ? (
          ...
          >
            ...
            <Link href={`/portal?lang=${lang}`} className="inline-block border border-primary-midnight text-primary-midnight hover:bg-primary-midnight hover:text-white px-8 py-3 text-sm font-medium uppercase tracking-widest transition-colors">
