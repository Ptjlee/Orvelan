...
export function Hero({ lang }: { lang: "fr" | "en" }) {
  ...
  return (
    <section className="min-h-screen bg-[#FAFAFA] flex items-end pb-24 relative overflow-hidden">
      {/* Absolute minimal geometric ambient detail */}
      ...
      <div className="max-w-[1400px] w-full mx-auto px-6 md:px-12 mt-32 md:mt-0 flex flex-col md:flex-row justify-between items-end gap-16">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl lg:text-[5.5rem] font-serif text-primary-midnight leading-[1.05] tracking-tight mb-12">
            {lang === "fr" ? (
              <>Tenir le cap <br/><span className="italic text-primary-charcoal">sous tension.</span></>
            ) : (
              <>Staying the course <br/><span className="italic text-primary-charcoal">under pressure.</span></>
            )}
          </h1>
        </motion.div>
        ...
        >
          ...
          <a href="#about" className="group inline-flex items-center gap-4 text-primary-midnight font-medium hover:text-primary-copper transition-colors">
            {t.cta}
